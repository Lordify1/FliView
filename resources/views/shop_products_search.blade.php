...
@section("content")
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            <form action="{{route('shop.search_items')}}">
            <div class="input-group">
                <input type="text" name="search_shop_products" placeholder="Search Products" class="form-control" id="search_shop_products">
    ...
    <div class="container-fluid pt-5">
        <div class="row px-xl-5" id="all_products_box">
            ...
            <h3 class="display-4 text-center">Nothing matched your search. Try searching again with another keyword</h3>
            @endif
            ...
            <div class="col-lg-3 mb-5">
                ...
                <?php $product_images = DB::select('select image_name from product_images where product_id = ? LIMIT 1', [$product->id]);?>
                    ...
                    <div class="col text-center">
                        <?php $category = DB::select('select cat_name from product_categories where id = ?', [$product->product_status_id]) ?>
