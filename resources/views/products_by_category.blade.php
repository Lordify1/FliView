    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            ...
            <div class="input-group">
                <input type="text" name="search" placeholder="Search Products" class="form-control" id="search_all_products">
                <button class="btn bg-primary text-white"><i class="fa fa-search"></i></button>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
